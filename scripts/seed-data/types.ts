/**
 * สำเนาโครงสร้างข้อมูลตอนก่อนย้ายเข้า CMS — แช่แข็งไว้เพื่อให้สคริปต์ seed ยังใช้ได้
 *
 * ของจริงที่หน้าเว็บใช้อยู่ที่ src/content/types.ts ซึ่งเปลี่ยนไปแล้ว
 * (หมวดหมู่และผู้ผลิตกลายเป็นอ็อบเจกต์เต็ม แทนที่จะเป็นเพียง slug)
 */
/**
