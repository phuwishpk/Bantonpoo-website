...
ภาพตอนแชร์ลิงก์ เปลี่ยนลิงก์ ปรับสีและ layout ของส่วน และตั้งค่าที่เป็นตัวเลือกทั้งหมด
...
| `/api/inline-edit` | บันทึกข้อความ เปลี่ยนรูป และเผยแพร่ |
...
> `check:inline` `check:images` และ `check:pages` แก้เนื้อหาจริงชั่วคราว และ `check:inline`
> กดเผยแพร่หน้าแรกหนึ่งครั้ง ถ้ามีฉบับร่างของหน้าแรกค้างอยู่ ฉบับร่างนั้นจะถูกเผยแพร่ไปด้วย
>
