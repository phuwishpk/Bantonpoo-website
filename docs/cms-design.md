...
>
> **ผลต่อขั้นตอน deploy** — SQLite ไม่มีโพรโทคอลเครือข่าย จึงรัน migration จากเครื่องเรา
> ผ่านอุโมงค์ SSH ไม่ได้ ต้องรันบนเซิร์ฟเวอร์ (ดูคู่มือ deploy หัวข้อ 7)
...
**หน้าสินค้าและบทความถูกสร้างตอน build โดยอ่านจากฐานข้อมูล** — สคริปต์ deploy จึงคัดลอก
ไฟล์ฐานข้อมูลของเซิร์ฟเวอร์ลงมาอ่าน (อ่านอย่างเดียว ไม่เขียนกลับ) แล้วลบสำเนาทิ้งเมื่อจบ
